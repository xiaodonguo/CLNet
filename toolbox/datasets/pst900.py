...
from Semantic_Segmentation_Street_Scenes.toolbox.datasets.augmentations import Resize, Compose, ColorJitter, RandomHorizontalFlip, RandomCrop, RandomScale, \
    RandomRotation
...
if __name__ == '__main__':
    path = '/home/user/projects/Segmentation_final/PST900/PST900_RGBT_Dataset/test/rgb'
    name = os.listdir(path)
    name.sort()
    save = '/home/user/projects/Segmentation_final/PST900/PST900_RGBT_Dataset/test.txt'
